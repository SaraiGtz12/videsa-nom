...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        <title>Grupo Ferretero Progreso</title>
        <!-- Icons -->
        ...
        <link rel="stylesheet" href="<?=asset_url()?>js/plugins/datatables/buttons.dataTables.min.css">
		<!-- AutoComplete --> 
        ...
        <!-- FancyBox -->
		<link href="<?=asset_url()?>js/plugins/fancybox/jquery.fancybox.css?v=2.1.5" rel="stylesheet">
