...
<body>
    <main>
        <?php include('pdf.recursos.headerGeneral'); ?>
        ...
        <?php include('pdf.recursos.footerCaratula'); ?>
        <!-- pagina 2-->
        <div style="page-break-before: always;"></div>
        <?php include('pdf.recursos.headerCaratula'); ?>
    ...
    <!-- paginas 3 -->
   <?php include('pdf.recursos.headerGeneral'); ?>
    <?php include('pdf.recursos.footerGeneral'); ?>           
    <div style="page-break-before: always;"></div>
     <!-- paginas 4 -->
   <?php include('pdf.recursos.headerGeneral'); ?>
    <?php include('pdf.recursos.footerGeneral') ; ?>
